...
classe: D
owner: OPS
stato: ATTIVA — ratificata da Davide il 2026-09-06 («Procedi»)
created: 2026-09-05
...
revisioni:
  - 2026-09-06, PM — **ratifica di Davide («Procedi»): stato da PROPOSTA ad ATTIVA.** Chiuse nello stesso giro due domande che OPS aveva girato a Davide, e chiuse **da un fatto verificato, non da una decisione**: il blocco copiabile *non* era sparito dalla pagina, è diventato il ripiego di `submit-evento.html` (righe 311-318) per chi non ha un'app di posta, e il testo dentro lo **compone il questionario** (`submit-evento.js:323`). Di conseguenza il separatore `, ` **non va insegnato a nessuno**: non lo digita nessuno. La decisione del 05/09 «l'esempio sta dentro il blocco copiabile» riguardava la vecchia pagina di istruzioni, che Davide ha sostituito col questionario lo stesso giorno; non è decaduta, è stata assorbita.
